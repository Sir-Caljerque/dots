...
wk.add({
  -- Code group - <leader>{cf,cF,cdc,cdl}
  {
    ...
    { "<S-j>",       "<cmd>Lspsaga diagnostic_jump_next<CR>",             desc = "Jump to next diagnostic", silent = true, noremap = true },
    { "<S-k>",       "<cmd>Lspsaga diagnostic_jump_prev<CR>",             desc = "Jump to prev diagnostic", silent = true, noremap = true },
